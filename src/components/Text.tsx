...
const textVariants = cva(
  'tracking-tight transition-color duration-300 ease-in-out',
  {
    variants: {
      size: {
        10: 'text-[1rem]',
        ...
        48: 'text-[3.2rem] md:text-[4.8rem] leading-[1.2]',
        56: 'text-[4rem] md:[text-[4.8rem] lg:text-[5.6rem] leading-[1.2]',
        64: 'text-[4rem] md:text-[5.6rem] lg:text-[6.4rem] leading-[1.1]',
        80: 'text-[4rem] md:text-[6.4rem] lg:text-[8rem] leading-[1.1]',
